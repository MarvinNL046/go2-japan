...
const WIDGET_SCRIPTS: Record<string, string> = {
  ...
  '12go': 'https://tpembd.com/content?trs=421888&shmarker=602467&locale=en&from=Tokyo&to=Osaka&from_en=Tokyo&to_en=Osaka&powered_by=true&color=black&border=1&campaign_id=44&promo_id=1506',
              ...
              <aside className="lg:col-span-4 lg:self-start">
                ...
                <div className="bg-white rounded-2xl shadow-md p-6">
                  ...
                  <div className="space-y-2">
                    <Link href="/city/" className="block text-brand-secondary hover:underline text-sm">Japan Cities</Link>
                    <Link href="/visa/" className="block text-brand-secondary hover:underline text-sm">Visa Guide</Link>
                    <Link href="/food/" className="block text-brand-secondary hover:underline text-sm">Japanese Food</Link>
                ...
                <TripcomWidget city="Japan" type="searchbox" customTitle="Find Japan Hotels" />
                ...
                {/* eSIM */}
                <div className="bg-white rounded-2xl shadow-md p-6">
                  <h3 className="text-xl font-bold font-display mb-2">Japan eSIM</h3>
                  <p className="text-sm text-gray-600 mb-4">
                    Stay connected in Japan. Order your eSIM before you go.
                  </p>
                  <a
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-white">
                <h2 className="text-2xl font-bold font-display mb-1">Plan Your Japan Trip</h2>
